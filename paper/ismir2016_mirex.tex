...
However, we note two potential challenges to the distributed computation approach.
...
\begin{itemize}
\item availability and distribution of content,
\item quality control, and
\item coverage and representation bias.
\end{itemize}

The first point can be addressed by using only creative commons licensed music.
Luckily, a wealth of this data is available through the Free Music Archive
(FMA),\footnote{\url{http://freemusicarchive.org/}} which hosts a variety of music
content under either public domain or creative commons licenses.\footnote{\url{https://creativecommons.org/licenses/}}
...
Several recent studies have investigated the use of algorithm disagreement for detecting ``hard'' examples, be it for beat tracking~\cite{holzapfel2012selective}, structural analysis~\cite{nieto2015discovering}, or chord recognition~\cite{humphrey2015fourtimely}.
