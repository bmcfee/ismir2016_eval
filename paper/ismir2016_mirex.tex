...
The theory goes, if participants don't see the data, it's harder to overfit.
...
Moreover, step 4 requires a considerable amount of volunteer effort to maintain, through the so-called ``task captains''ù, as well as various administration and maintenance issues.
