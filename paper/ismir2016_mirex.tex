...
The Music Information Retrieval eXchange is a framework for the community driven evaluation of MIR algorithms~\cite{downie2008music, downie2010music}.
...
%JU: English thing...so footnote numbers go after the sentence's period? I always put them before; have I been doing it wrong?
...
\end{itemize} %JU: it's a bit weird that we first itemize as i)ii)iii) and then use bullets.
...
In this section, we elaborate on several points relating to the goals and implementation of the proposed framework. %JU: can we get rid of this para to gain 2 lines?
...
This begs an obvious question: why will things change \emph{now}?
...
\vspace{1ex}\noindent\textbf{Acknowledgments.} J.U. is supported by the Spanish Government: JdC postdoctoral fellowship, and projects TIN2015-70816-R and MDM-2015-0502.
