...
Often, when evaluation datasets are updated, algorithm scores drop precipitously.
...
By and large, MIREX has relied on the generosity of the community to expand the size of its evaluation datasets.
...
Data collection is a harsh, unavoidable reality, and one that a demands a viable plan going forward.
