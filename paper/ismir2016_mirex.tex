...
To circumvent these challenges, we propose a distributed, community-centric paradigm for system evaluation, \'a la Kaggle, built upon the principles of openness, transparency and reproducibility.
