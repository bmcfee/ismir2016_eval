...
While MIREX has successfully operated for over a decade, its long-term sustainability is hindered by several factors, most notably the cost of maintenance.
In this document, we outline the goals, benefits, and limitations of community-based system evaluation, and then propose an alternative framework built upon the principles of openness, transparency and reproducibility. 
We argue that this proposal has the potential to reduce operating cost, improve scalability, and will eventually result in the release of open evaluation data for improving MIR techniques and evaluation methods.
\end{abstract}
%
