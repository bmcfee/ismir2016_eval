...
In addition to empirical results reported in individual articles, community evaluation campaigns --- such as MIREX~\cite{downie2008music}, MusiClef~\cite{orio2011musiclef}, or the MSD Challenge~\cite{mcfee2012million} --- provide a mechanism standardize methodology, datasets, and metrics to benchmark research systems.
...
In this article, we propose a sustainable, open framework for community-driven MIR evaluation campaigns.
...
We stress that this document describes not a fully implemented system, but a \emph{proposal} put forward by a group of authors dedicated to seeing it put into practice.
...
In collaboration with the community, we hope to develop a framework that benefits as many as people as possible and require minimal financial support for years to come.
