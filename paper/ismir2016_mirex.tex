...
%MIREX got a Mellon grant for \$1.2M; what if more of that could have been allocated to annotation?
%We've been able to procure funding in the past for projects, and can divert those resources to annotation.

% Crowd-sourced
Second, for tasks that require minimal annotator training, we can leverage either crowd-sourcing platforms, \eg Mechanical Turk\footnote{\url{https://www.mturk.com/}}, or seek out enthusiastic user communities that would be willing to participate in \emph{citizen science} for music on a volunteer basis.
...
Pick a task, guitar chord transcription.
