...
The second potential drawback is reduced transparency on behalf of the participants.
While MIREX forces some form of transparency by requiring that submissions execute on a remote server beyond the participants' control, the scheme proposed here drops that requirement.
