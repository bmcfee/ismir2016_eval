...
Even now, there are several steps necessary to make this a reality within the year:
one, establish a robust instrument taxonomy as a community, a key to ImageNet's success;
two, requisition a large plurality of audio content, \eg mirror FMA;
three, build a web-based annotation tool, uploading annotations from the browser to a hosted content management system.
four, consolidate existing datasets into a common format as a development dataset;
five, implement or collect a few simple algorithms to prioritize content for annotation;
six, perform data collection, through some combination of paid annotation, crowd-sourcing, and community support;
and finally, establish an evaluation server and leaderboard to accept and score submissions.
% Final call-to-action -- ejh needs halp.
By collaborating together, we have the potential to save the world. Alright!
