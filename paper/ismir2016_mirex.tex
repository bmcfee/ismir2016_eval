...
% Cheap to rent compute time
Cloud computing is cheap and ubiquitous, to the point that practically no one in industry builds and maintains their own compute resources.
% Web infrastructure is better
Bandwidth is vastly improved, so bringing data to computation is feasible.
...
Creative commons music is now ample, making the dream of sharing data a reality.
...
% Ample micro-services that are free for education or non-profits.
