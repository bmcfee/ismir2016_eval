...
%
\begin{abstract}
The Music Information Retrieval Evaluation eXchange (MIREX) provides a valuable community service by
establishing standard baselines for comparing MIR methods.  While MIREX has successfully operated for over a
decade, its long-term sustainability is hindered by several factors, notably the cost of maintenance.
In this document, we outline the goals, benefits, and limitations of community-based system evaluation.
We then propose an alternative system which reduces operating cost, improves scalability, and will eventually
result in the release of open evaluation data for MIR tasks.
\end{abstract}
%
